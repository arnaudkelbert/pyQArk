...
from pyQArk.Dialogs.QArkWarningMessageBox.QArkWarningMessageBox import QArkWarningMessageBox

TEST_CLASS = QArkWarningMessageBox
class QArkWarningMessageBoxTest(unittest.TestCase):
    """
    Test
    """
