...
from .Ui_QArkSetNotationPlotWidgetDialog import Ui_QArkSetNotationPlotWidgetDialog
...
class QArkSetNotationPlotWidgetDialog( QtGui.QDialog, Ui_QArkSetNotationPlotWidgetDialog ):
