...
# Form implementation generated from reading ui file 'QArkOpenFilterFileDialog.ui'
#
# Created: Sun Jul 27 22:25:35 2014
...
class Ui_QArkOpenFilterFileDialog(object):
    ...
    def retranslateUi(self, QArkOpenFilterFileDialog):
        ...
        self.directoryLabel.setText(_translate("QArkOpenFilterFileDialog", "Répertoires", None))
        self.fileLabel.setText(_translate("QArkOpenFilterFileDialog", "Fichiers", None))
        self.filterLabel.setText(_translate("QArkOpenFilterFileDialog", "Filtre", None))
