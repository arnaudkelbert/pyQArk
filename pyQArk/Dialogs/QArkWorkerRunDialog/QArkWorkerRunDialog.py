...
from .Ui_QArkWorkerRunDialog import Ui_QArkWorkerRunDialog
from ...Core.QArkWorkerController import QArkWorkerController
...
class QArkWorkerRunDialog( QtGui.QDialog, Ui_QArkWorkerRunDialog ):
    """
