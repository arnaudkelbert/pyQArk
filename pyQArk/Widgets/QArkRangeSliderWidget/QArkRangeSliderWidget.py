...
from .Ui_QArkRangeSliderWidget import Ui_QArkRangeSliderWidget
...
class QArkRangeSliderWidget( QtGui.QWidget, Ui_QArkRangeSliderWidget ):
    """
    """
    def __init__( self
                 , parent = None
