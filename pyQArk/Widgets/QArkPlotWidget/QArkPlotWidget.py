...
#                       )
    ...
    #def setFocusPlot( self, _t_index ):
        #if len(self.t_indexFocusPlot) > 0:
            ## First change the previous focus color to its original color
            #for u_idx in self.t_indexFocusPlot:
                #self.updatePlotPen( u_idx )

        #self.t_indexFocusPlot = _t_index

        #for u_idx in self.t_indexFocusPlot:
            #self.setPlotColor( u_idx, self.o_focusColor )
