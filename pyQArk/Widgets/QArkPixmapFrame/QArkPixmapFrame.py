...
class QArkPixmapFrame( QtGui.QFrame ):
    """
    """
    ...
    def initUi(self):
        self.o_scene = QtGui.QGraphicsScene()
        self.o_graphicView = QtGui.QGraphicsView( self.o_scene )
        ...
        o_layout = QtGui.QGridLayout()
        o_layout.setContentsMargins(0, 0, 0, 0)
        o_layout.addWidget(self.o_graphicView, 0, 0)
        self.setLayout(o_layout)

        #self.o_graphicView.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        #self.o_graphicView.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
    ...
    def paintImagePixmap(self):
        ...
        self.o_imagePixmapItem = QtGui.QGraphicsPixmapItem(scene=self.o_scene)
