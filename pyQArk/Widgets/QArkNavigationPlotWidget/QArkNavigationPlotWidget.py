...
from ..QArkNavigationTabWidget.QArkNavigationTabWidget import QArkNavigationTabWidget

try:
    from ..QArkPlotWidget.QArkPlotWidget import QArkPlotWidget
except ImportError as e:
    print 'Exception : '
    print str(e)
    print 'Continue...'

from ...Dialogs.QArkExportPlotWidgetDialog.QArkExportPlotWidgetDialog import QArkExportPlotWidgetDialog
from ...Dialogs.QArkSetAxisRangePlotWidgetDialog.QArkSetAxisRangePlotWidgetDialog import QArkSetAxisRangePlotWidgetDialog
from ...Dialogs.QArkSetNotationPlotWidgetDialog.QArkSetNotationPlotWidgetDialog import QArkSetNotationPlotWidgetDialog

from ..QArkPlotPenSettingsWidget.QArkPlotPenSettingsWidget import QArkPlotPenSettingsWidget
...
class QArkNavigationPlotWidget( QtGui.QWidget ):
    """
    ...
    def initUi( self ):
        ...
        self.ui_qSplitterV = QtGui.QSplitter( self )
        ...
        self.ui_qSplitterH = QtGui.QSplitter( self )
    ...
    def handleSelectionChangedSlot( self, sendingView, selected, deselected ):
        ...
        #t_intersect = list(set(t_deselectedItemData) & set(t_selectedItemData))
        ...
        ## Activate pen settings
        #if len( t_selectedItemData ) > 0:

            ## If items are selected : enable pen settings
            ## with first item's settings
            #self.enablePenSettings( t_selectedItemData[0] )
