...
TEST_CLASS = QArkStringComboBoxWidget
class QArkStringComboBoxWidgetTest(unittest.TestCase):
    """
    Test
    """
    class _ControllerWidget(QtWidgets.QWidget):
        ...
        def initUi(self):
            ...
            self.o_widget = TEST_CLASS(self, _s_label='label', _x_initValue=['v1','v2','v3'])
