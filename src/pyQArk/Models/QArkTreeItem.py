...
class QArkTreeItem( object ):
    ...
    def __lt__( self, o_right ):
        return self.o_data.__lt__( o_right.o_data )


    def __eq__( self, o_right ):
        return self.o_data.__eq__( o_right.o_data )
    ...
    def insertChild( self, _u_row, _o_item ):
        self.t_childItems.insert( _u_row, _o_item )


    def popChild( self, _u_row ):
        return self.t_childItems.pop( _u_row )
