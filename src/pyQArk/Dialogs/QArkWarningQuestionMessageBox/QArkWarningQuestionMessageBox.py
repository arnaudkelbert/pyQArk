...
class QArkWarningQuestionMessageBox(QtWidgets.QMessageBox):
    ...
    def isReplyIgnore(self):
        return self.u_reply == QtWidgets.QMessageBox.Ignore

    def isReplyAbort(self):
        return self.u_reply == QtWidgets.QMessageBox.Abort
