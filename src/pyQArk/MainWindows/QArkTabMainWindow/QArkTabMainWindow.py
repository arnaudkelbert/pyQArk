...
class QArkTabMainWindow( QtWidgets.QMainWindow, QArkExceptionHandableObject ):
    """
    ...
    def initUiComponents( self ):
        ...
        """
        # init the tab widget
        self.ui_mainWidget = QtWidgets.QTabWidget()
        ...
        self.ui_mainWidget.setTabPosition(QtWidgets.QTabWidget.North)
        self.ui_mainWidget.setTabShape(QtWidgets.QTabWidget.Rounded)
    ...
    def addTabWidget( self, _o_widget, _s_label ):
        """
        Add a tab widget
        """
        o_tabWidget = QtWidgets.QWidget()
        o_tabWidget.setObjectName(_fromUtf8("{}".format(_s_label.replace(' ','_'))) )
        o_vlayout = QtWidgets.QVBoxLayout(o_tabWidget)
        o_vlayout.setSpacing(0)
        o_vlayout.setContentsMargins(0,0,0,0)
    ...
    def setCurrentIndex( self, _u_index=0 ):
        """
        Set current tab widget
        """
        self.ui_mainWidget.setCurrentIndex( _u_index )
