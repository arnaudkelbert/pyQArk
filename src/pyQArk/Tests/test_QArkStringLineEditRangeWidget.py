...
TEST_CLASS = QArkStringLineEditRangeWidget
class QArkStringLineEditRangeWidgetTest(unittest.TestCase):
    """
    Test
    """
    class _ControllerWidget(QtWidgets.QWidget):
        ...
        def initUi(self):
            ...
            self.o_widget = TEST_CLASS(self, _s_label='label', _x_initValue=QArkRange(10,20))
