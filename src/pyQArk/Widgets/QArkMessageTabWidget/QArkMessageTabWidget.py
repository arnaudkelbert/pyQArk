...
Ui_QArkMessageTabWidget = loadUi(PKGPATH('./QArkMessageTabWidget.ui'), pkgname=__name__.rpartition('.')[0])
...
class QArkMessageTabWidget( QtWidgets.QTabWidget, Ui_QArkMessageTabWidget ):
    """
